# Hi, I'm PAKOU Komi Juste 👋

### Full Stack Developer | Java · Spring Boot · Angular | DevOps Enthusiast
📍 Lomé, Togo 🇹🇬 · 💼 NITCH-CORP
...
scalable REST APIs and dynamic web applications.
Currently working at NITCH-CORP on **Projet TITAN** — a multi-service
marketplace for West Africa built with Spring Modulith.

- 🔭 Currently working on **Projet TITAN** (marketplace multi-services)
...
|--------|-------------|-------|
| [🛒 Projet TITAN](https://pakoujuste.vercel.app) | Marketplace multi-services Afrique de l'Ouest | Spring Modulith · Angular · PostgreSQL |
| [📚 Online Bookstore](https://github.com/Juste120/online-bookstore-management-system) | Enterprise backend REST API | Spring Boot · PostgreSQL · Docker |
| [🔒 Secure File Management](https://github.com/Juste120/secure-file-management-system) | Secure file system avec MinIO | Spring Boot · MinIO · JWT |
| [🌳 Family Tree](https://github.com/Juste120/family-tree) | Application arbre généalogique | Spring Boot · Neo4j |
| [🏨 ChambrePro](https://github.com/Juste120/ChambrePro) | API réservation de chambres | Spring Boot · PostgreSQL |

---

## 📫 Connect with Me

[![Portfolio](https://img.shields.io/badge/Portfolio-pakoujuste.vercel.app-teal?style=for-the-badge&logo=vercel)](https://pakoujuste.vercel.app)
